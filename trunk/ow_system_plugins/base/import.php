...
class BASE_Import extends DATAIMPORTER_CLASS_Import
{
    ...
    public function import( $params )
    {
        ...
        try
        {
            OW::getDbo()->query( "INSERT IGNORE INTO `" . OW_DB_PREFIX ."_base_menu_item` ( `prefix`, `key`, `documentKey`, `type`, `order`, `routePath`, `externalUrl`, `newWindow`, `visibleFor`) VALUES ( 'admin', 'sidebar_menu_plugins_add', '', 'admin_plugins', 3, 'admin_plugins_add', NULL, 0, 2) ");
        }
        catch( Exception $ex )
        {
        ...
        try
        {
            OW::getDbo()->query( "INSERT IGNORE INTO `" . OW_DB_PREFIX ."_base_menu_item` ( `prefix`, `key`, `documentKey`, `type`, `order`, `routePath`, `externalUrl`, `newWindow`, `visibleFor`) VALUES ( 'admin', 'sidebar_menu_themes_add', '', 'admin_appearance', 3, 'admin_themes_add_new', NULL, 0, 3) ");
        }
        catch( Exception $ex )
        {
