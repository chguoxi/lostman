...
class BASE_CTRL_AjaxComponentAdminPanel extends BASE_CTRL_AjaxComponentPanel
{
    ...
    protected function saveSettings( $data )
    {
        ...
        try
        {
            $this->validateComponentSettingList($componentClass, $settings, $data['place']);
        }
        ...
        $settings = $this->processSettingList($componentClass, $settings, $data['place'], true);
    ...
    protected function getSettingsMarkup( $data )
    {
        ...
        $componentSettingList = $this->getComponentSettingList($componentClass);
        ...
        $cmp = new BASE_CMP_ComponentSettings($componentPlaceUniqName, $componentSettingList, $entitySettingList);
