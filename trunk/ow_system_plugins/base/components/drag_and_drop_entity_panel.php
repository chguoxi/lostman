...
class BASE_CMP_DragAndDropEntityPanel extends BASE_CMP_DragAndDropPanel
{
    ...
    public function onBeforeRender()
    {
        ...
        if ( $this->customizeMode )
        {
            ...
            parent::initializeJs($this->responderController, 'OW_Components_DragAndDrop', $sharedData);
    ...
    public function tplComponent( $params )
    {
        ...
        $viewInstance = new BASE_CMP_DragAndDropItem($uniqName, in_array($uniqName, $this->entityClonedNameList), $template);
