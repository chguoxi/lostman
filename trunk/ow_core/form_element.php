    ...
    public function renderInput( $params = null )
    {
        ...
        if ( $config === 'dmy' )
        {
            $result = '<div class="' . $this->getAttribute('name') . '">
                            ...
                            <div style="display:inline;">' . UTIL_HtmlTag::generateTag('select', $dayAttributes, true, $dayOptionsString) . '</div>
                            <div style="display:inline;">' . UTIL_HtmlTag::generateTag('select', $monthAttributes, true, $mounthOptionsString) . '</div>
                            <div style="display:inline;">' . UTIL_HtmlTag::generateTag('select', $yearAttributes, true, $yearOptionsString) . '</div>
                        </div>';
        }
        else
        {
...
class AgeRange extends FormElement
{
    ...
    public function renderInput( $params = null )
    {
        ...
        OW::getDocument()->addOnloadScript(" window.join = new AgeRangeField( '" . ( $this->getName() ) . "', " . ( $this->minAge ) . ", " . ( $this->maxAge ) . " ); ");
        ...
        $result = '<div id="' . $this->getAttribute('id') . '"class="' . $this->getAttribute('name') . '">
                        ...
                        <div style="display:inline;">' . UTIL_HtmlTag::generateTag('select', $fromAgeAttrs, true, $fromAgeOptionsString) . '</div>
                        <div style="display:inline;padding-left:5px;padding-right:5px;">' . $language->text('base', 'form_element_to') . '</div>
                        <div style="display:inline;">' . UTIL_HtmlTag::generateTag('select', $toAgeAttrs, true, $toAgeOptionsString) . '</div>
                        <div style="display:inline;padding-left:5px;">' . $language->text('base', 'form_element_age_range') . '</div>
                    </div>';
...
class DateRange extends FormElement
{
    ...
    public function renderInput( $params = null )
    {
        ...
        $result = '<div id="' . $this->getAttribute('id') . '" class="' . $this->getAttribute('name') . '">
                       ' . $language->text('base', 'form_element_from') . '  <div style="display:inline;">' . ( $this->minDate->renderInput() ) . '</div>
                       ' . $language->text('base', 'form_element_to') . '
                       <div style="display:inline;">' . ( $this->maxDate->renderInput() ) . '</div>
                    </div>';
...
class YearRange extends FormElement
{
    ...
    public function renderInput( $params = null )
    {
        ...
        OW::getDocument()->addScript(OW::getPluginManager()->getPlugin("base")->getStaticJsUrl() . 'age_range_field.js');
        OW::getDocument()->addOnloadScript(" window.join = new AgeRangeField( '" . ( $this->getName() ) . "', " . ( $this->minYear ) . ", " . ( $this->maxYear ) . " ); ");
        ...
        $result = '<div id="' . $this->getAttribute('id') . '"class="' . $this->getAttribute('name') . '">
                        <div style="display:inline;padding-left:5px;padding-right:5px;">' . $language->text('base', 'form_element_from') . '</div>
                        <div style="display:inline;">' . UTIL_HtmlTag::generateTag('select', $fromYearAttrs, true, $fromAgeOptionsString) . '</div>
                        <div style="display:inline;padding-left:5px;padding-right:5px;">' . $language->text('base', 'form_element_to') . '</div>
                        <div style="display:inline;">' . UTIL_HtmlTag::generateTag('select', $toYearAttrs, true, $toAgeOptionsString) . '</div>
                        <div style="display:inline;padding-left:5px;">' . $language->text('base', 'form_element_year_range') . '</div>
                    </div>';
