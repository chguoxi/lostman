...
class OW_Theme
{
    ...
    {
        return $this->themeService->getStaticDir($this->dto->getName());
    }
    ...
    {
        return $this->themeService->getStaticUrl($this->dto->getName());
    }
     ...
     * @return string
     */
    public function getStaticImagesDir()
    {
        return $this->themeService->getStaticImagesDir($this->dto->getName());
    }
     ...
     * @return string
     */
    public function getStaticImagesUrl()
    {
        return $this->themeService->getStaticImagesUrl($this->dto->getName());
    }
    ...
    {
        return $this->themeService->getRootDir($this->dto->getName());
    }
     ...
     * @return string
     */
    public function getMasterPagesDir()
    {
        return $this->themeService->getMasterPagesDir($this->dto->getName());
    }
    ...
    {
        return $this->themeService->getImagesDir($this->dto->getName());
    }
