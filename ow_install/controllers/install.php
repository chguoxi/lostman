...
class INSTALL_CTRL_Install extends INSTALL_ActionController
{
    public function requirements()
    {
        ...
        {
            $this->redirect( OW::getRouter()->urlForRoute('main') );
        }
    }
    ...
    public function main()
    {
        ...
        INSTALL::getStepIndicator()->activate('main');
    ...
    private function installComplete( $installPlugins = null )
    {
        ...
        $this->redirect(OW_URL_HOME . 'install/completed?redirect=1');
    }
