...
define('OW_URL_HOME', 'http://www.lunluoren.com/');

define('OW_DB_HOST', 'localhost');
define('OW_DB_PORT', null);
define('OW_DB_USER', 'root');
define('OW_DB_PASSWORD', 'chguoxi33651');
define('OW_DB_NAME', 'chguoxi');

define('OW_DB_PREFIX', 'ls_');
...
define('OW_PASSWORD_SALT', '4fe7e367b1154');
